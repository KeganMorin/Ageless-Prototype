  ...
  namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class DynamicMoveProvider : ActionBasedContinuousMoveProvider
    {
        ...
        protected override Vector3 ComputeDesiredMove(Vector2 input)
        {
            ...
            var combinedPosition = Vector3.Lerp(m_RightMovementPose.position, m_LeftMovementPose.position, leftHandBlend); //* spd.movespeed;
    ...
    public partial class MoveSpeed : MonoBehaviour
    {
